...
:start
	echo [101;93m                                                                                                                    [0m
	echo [101;93m                                      [37m Bug-G Tools - @RTK_JulliZ - v1.0.3 Mar-2022                                  [0m
	echo [101;93m                                                                                                                    [0m
	ECHO.
	ECHO [101;93m Escolha uma opção:                                                                                                 [0m
	ECHO.
	ECHO     [95m 1. Corrigir Lag na Rede (Requer Admin) [0m
	ECHO     [33m 2. Ativar vídeos [0m
	ECHO     [91m 3. Desativar vídeos [0m
	ECHO     [94m 4. Backup de configurações [0m
	ECHO     [93m 5. Restaurar backup [0m
	ECHO     [92m 6. Ativar CrashReporter [0m
	ECHO     [90m 7. Desativar CrashReporter [0m
	ECHO.
	...
	if '%choice%'=='6' GOTO ATIVAR_CRASHREPORTER
	if '%choice%'=='7' GOTO DESATIVAR_CRASHREPORTER
	...
	GOTO start
		...
		:ATIVAR_CRASHREPORTER
			CLS
			ECHO [43m                                                                                                             [0m
			ECHO [43m                         Iniciando comandos para ativar o BroCrashReporter ...                               [0m
			ECHO [43m                                                                                                             [0m
			ECHO.
			timeout /t 3 /nobreak >nul
			CLS
			...
			ECHO.
			ECHO [33m                                  Ativando BroCrashReporter...                                          [0
			ECHO.
			timeout /t 2 /nobreak >nul
			...
			ECHO                       [102m                                                                        [0m
			ECHO                       [102m                A APLICAÇÃO DE REPORT DE BUG FOI ATIVADA                [0m
			ECHO                       [102m         Caso mude de ideia, você poderá reverter a operação.           [0m
			ECHO                       [102m                                                                        [0m
			ECHO.
			ECHO.
		...
		:DESATIVAR_CRASHREPORTER
			CLS
			ECHO [41m                                                                                                             [0m
			ECHO [41m                        Iniciando comandos para desativar BroCrashReporter ...                               [0m
			ECHO [41m                                                                                                             [0m
			ECHO.
			timeout /t 3 /nobreak >nul	
			CLS
			...
			ECHO.
			ECHO [91m                                  Desativando BroCrashReporter...                                  [0
			ECHO.
			timeout /t 2 /nobreak >nul
			CD /D "%steam_path%\steamapps\common\PUBG\TslGame\Binaries\ThirdParty\BroCrashReporter"
			del *.exe_BAK
			...
			ECHO                       [102m                                                                        [0m
			ECHO                       [102m               A APLICAÇÃO DE REPORT DE BUG FOI DESATIVADA              [0m
			ECHO                       [102m         Caso mude de ideia, você poderá reverter a operação.           [0m
			ECHO                       [102m                                                                        [0m
			ECHO.
			ECHO.
