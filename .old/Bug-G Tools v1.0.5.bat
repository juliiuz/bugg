chcp 65001
mode con:cols=92 lines=43
title BUG-G v1.0.5 Apr-2024 (by JuliiuZ)
setlocal
call :setESC
CLS
...
:start
	CLS
	echo [101;93m                                                                                            [0m
	echo [101;93m                        Bug-G Tools by @JuliiuZ - v1.0.5 Apr-2024                           [0m
	echo [101;93m                                                                                            [0m
	ECHO.
	ECHO   [95m ************************************** WINDOWS **************************************** [0m
	ECHO   [95m *                                                                                    [95m * [0m
	ECHO   [95m *  •[0m Corrigir Lag na rede [95m[10][0m [90mADM[0m                                                   [95m * [0m
	ECHO   [95m *  •[0m Encerrar processos irrelevantes [95m[11][0m [90mADM[0m                                        [95m * [0m
	ECHO   [95m *  •[0m Otimizar configurações para jogos [95m[13][0m [90mADM[0m                                      [95m * [0m
	ECHO   [95m *  •[0m Perfil de performance do Windows... [95m[12][0m [90m[0m                                       [95m * [0m
	ECHO   [95m *                                                                                    [95m * [0m
	ECHO   [95m *                                                                                    [95m * [0m
	ECHO   [95m *************************************************************************************** [0m
	ECHO.
	...
	if '%choice%'=='13' GOTO opt_config_games
	...
	GOTO start
		...
		:adjust_performance
			...
			:confirm_perf_mode
				ECHO [95m • Para qual perfil de desempenho você quer ajustar o Windows?[0m
				ECHO.
				ECHO.
